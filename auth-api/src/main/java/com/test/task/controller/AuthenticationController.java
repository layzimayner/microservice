...
import com.test.task.dto.user.UserLoginRequestDto;
import com.test.task.dto.user.UserLoginResponseDto;
...
import com.test.task.security.AuthenticationService;
...
public class AuthenticationController {
    ...
    @PostMapping("/login")
    @Operation(summary = "Login", description = "Return JWT and user info "
    ...
    public UserRegistrationDto register(@RequestBody @Valid
